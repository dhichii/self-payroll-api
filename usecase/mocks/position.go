...
// NewPositionRepository creates a new instance of PositionRepository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewPositionRepository(t testing.TB) *PositionRepository {
